...
BEGIN
    ...
    (
        ...
        CONSTRAINT CK_PlayerGameStats_NonNegative
            CHECK (
                PlayingTime >= 0 AND Turnovers >= 0 AND Rebounds >= 0 AND
                Assists >= 0 AND Steals >= 0 AND Blocks >= 0 AND
                FieldGoalsMade >= 0 AND FieldGoalsTaken >= 0 AND
