...
/****************************
 * 7. PlayerGameStats
 * NOTE: GameID removed - Players table already links to GameID
 ****************************/
...
VALUES
    ('Midwest Rec Basketball League',   1),
    ('West Coast Amateur Hoops League', 2);
GO
...
PRINT 'BasketballLeague560 created and seeded successfully.';
PRINT 'Totals: 4 Locations, 2 Leagues, 4 Seasons, 16 Teams, 52 Games, 260 Players, 260 PlayerGameStats rows.';
PRINT 'Stored Procedures: Location (4), League (4), Seasons (4), Teams (5), Games (4) = 21 total.';
GO